@php
    ...
    // Si es role_responsable_compras, solo puede eliminar si creó la entrega
    if ($user && $user->hasRole('role_responsable_compras', 'backpack')) {
        $canDelete = ($entry->delivered_by == $user->id);
    } else {
        // Otros roles pueden eliminar normalmente (excepto role_personal que no puede eliminar)
