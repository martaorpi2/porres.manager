...
@include('crud::fields.inc.wrapper_start')
    ...
    <div class="existing-file">
        ...
        @if (isset($field['temporary']))
            <a target="_blank" href="{{ \Storage::disk($field['disk'])->temporaryUrl(Arr::get($field, 'prefix', '').$field['value'], Carbon\Carbon::now()->addMinutes($field['temporary'])) }}">
        @else
            <a target="_blank" href="{{ \Storage::disk($field['disk'])->url(Arr::get($field, 'prefix', '').$field['value']) }}">
        @endif
        @else
